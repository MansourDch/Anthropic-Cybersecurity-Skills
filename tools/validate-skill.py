...
# Pre-compiled regular expressions for parse_frontmatter to improve performance.
# Profiling showed replacing inline re.match with these pre-compiled patterns
# reduced parse_frontmatter primitive function calls by ~78,000 and total
# execution time from ~0.345s to ~0.288s across 800+ skill validations.
