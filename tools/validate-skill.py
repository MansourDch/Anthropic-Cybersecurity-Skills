...
# Pre-compiled regexes for frontmatter parsing.
# Compiling them at the module level avoids lookup overhead in the tight inner loop
# during string matching across thousands of lines in SKILL.md files.
